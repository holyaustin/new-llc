...
const data = [
  {
    id: 1,
    avatar: author,
    authorName: 'Xela.Lopa',
    designation: 'CEO',
    text: `Our vision is to create a more socioeconomically equitable world. We’re particularly bullish on the combined efficacy of crypto, accessible investment vehicles, broader community-oriented financial initiatives, & education. Our mission is to leverage web3 technology, to generate social impact, close opportunity gaps, & create economic value for marginalized individuals.`,
  },
  {
    id: 2,
    avatar: author,
